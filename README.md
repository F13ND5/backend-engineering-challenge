...
To run the project just run the following command with the desired window size and input file:
	...
	python unbabel_cli.py --input_file events.json --out_file output.json --window_size 10
...
Usage of unbabel_cli:
  ...
  --out_file or -out
        to select the file for the output (not required | by default goes to "output.json")
  --window_size or -w
